...
WEBSITE_URL = "https://superbet.rs/sportske-opklade/tenis/sve"
...
def main():
    ...
    try:
        ...
        try:
            ...
            with open(
                "superbet_tennis_matches.csv", "w", newline="", encoding="utf-8"
            ) as file:
            ...
            print(
                f"Successfully processed {len(teamNames)} matches and saved to superbet_tennis_matches.csv"
            )
